...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendSMS(String userMessage, String userNumber){
        if(ContextCompat.checkSelfPermission(this, Manifest.permission.SEND_SMS)!= PackageManager.PERMISSION_GRANTED)  //Asks user for permission, once permission is taken at play store but this takes permission again
        {
